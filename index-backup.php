...
<head>
   ...
   <title>Full Stack Developer - Kishan Vaghera</title>
	<link rel="canonical" href="https://themejunction.net" />
               ...
               <div class="col-md-12">
                  <div class="section-header text-center">
                     ...
                     <p class="wow fadeInUp" data-wow-delay=".4s">
                        We transform your ideas and wishes into a unique web project that will inspire both you and your customers.
                     </p>
                  </div>
               </div>
            </div>
               ...
               <div class="col-md-12">
                  <div class="services-widget position-relative">
                     <div class="service-item current d-flex flex-wrap align-items-center wow fadeInUp"
                        ...
                        <div class="right-box">
                           <p>
                              We offer comprehensive website development services tailored to meet your unique needs, whether you're looking for a basic online presence or a dynamic, interactive platform.
                           </p>
                        </div>
                     ...
                     <div class="service-item current d-flex flex-wrap align-items-center wow fadeInUp"
                        ...
                        <div class="right-box">
                           <p>
                              We specialize in creating high-quality Android and iOS applications that offer seamless performance, intuitive design, and innovative features. Whether you need a simple app or a complex, feature-rich solution, our team has the expertise to bring your vision to life.
                           </p>
                        </div>
                        <i class="flaticon-up-right-arrow"></i>
                        <button data-mfp-src="#service-wrapper" class="service-link modal-popup"></button>
                     ...
                     <div class="service-item d-flex flex-wrap align-items-center wow fadeInUp" data-wow-delay=".6s">
                        ...
                        <div class="right-box">
                           <p>
                              Our ERP (Enterprise Resource Planning) system development service provides businesses with comprehensive and customizable solutions to streamline their operations, improve efficiency, and enhance decision-making. We specialize in creating robust ERP systems tailored to meet the unique needs of your organization.
                           </p>
                        </div>
                        <i class="flaticon-up-right-arrow"></i>
                        <button data-mfp-src="#service-wrapper" class="service-link modal-popup"></button>
                     ...
                     <div class="service-item d-flex flex-wrap align-items-center wow fadeInUp" data-wow-delay=".7s">
                        ...
                        <div class="right-box">
                           <p>
                              Our CRM (Customer Relationship Management) system development service helps businesses effectively manage interactions with current and potential customers. We specialize in creating tailored CRM solutions to optimize customer relationships, improve sales processes, and drive business growth.
                           </p>
                        </div>
                        <i class="flaticon-up-right-arrow"></i>
                        <button data-mfp-src="#service-wrapper" class="service-link modal-popup"></button>
                  ...
                  <div class="contact-info-list">
                     <ul class="ul-reset">
                        ...
                        <li class="d-flex flex-wrap align-items-center position-relative wow fadeInRight"
                           ...
                           <div class="text-box">
                              <p>Email</p>
                              <a href="mailto:mail@mail.com">kishanvaghera8219@gmail.com</a>
                           </div>
                        </li>
                        <li class="d-flex flex-wrap align-items-center position-relative wow fadeInRight"
                           data-wow-delay=".6s">
